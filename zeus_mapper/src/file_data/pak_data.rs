    ...
    impl GenerateData<EventData> for TestDataGenerator {
        fn generate_data(&mut self) -> EventData {
            return EventData {
                ...
                time_counter: self.generate_data(),
                event_status: self.generate_data(),
                needs_message_response: self.generate_data(),
                triggering_event_id: self.generate_data(),
                selector_id_or_warship_count: self.generate_data(),
                monster_target_1: self.generate_data(),
                monument: self.generate_data(),
                monster_target_2: self.generate_data(),
                monster_target_3: self.generate_data(),
                monster_aggression: self.generate_data(),
                unknown_row: self.generate_data(),
                on_late: self.generate_data(),
                on_lost: self.generate_data(),
                effect_on_city: self.generate_data(),
                ...
                progress_state: self.generate_data(),
                related_to_triggered_event: self.generate_data(),
                constant_1_0x00: self.generate_data(),
                ...
                ally_troop_count: self.generate_data(),
                own_troop_strength: self.generate_data(),
                constant_5_0x00: self.generate_data(),
                permanent_flag: self.generate_data(),
                quest: self.generate_data(),
                quest_high_byte: self.generate_data(),
            };
        }
    }

...
pub struct MythologyData {
    ...
    pub monster: u32,
    pub constant_1_0xff: BoxedArray<u8, 96>,
    pub constant_2_0x00: [u8; 12],
...
impl MythologyData {
    ...
    pub(crate) fn read_from(reader: &mut impl Read, include_pyramids: bool) -> io::Result<Self> {
        ...
        return Ok(MythologyData {
            ...
            constant_1_0xff: ReadFrom::read_from(reader)?,
    ...
    pub(crate) fn write_to<W: Write>(&self, writer: &mut W, include_pyramids: bool) -> io::Result<usize> {
        ...
        bytes += WriteTo::write_to(&self.constant_1_0xff, writer)?;
...
mod tests {
    ...
    fn read_write_without_pyramids() -> io::Result<()> {
        let original = MythologyData {
            ...
            proponent_gods: [2; 12],
            monster: 3,
            constant_1_0xff: BoxedArray::from_vec(vec![4; 96]),
            constant_2_0x00: [5; 12],
